...
type Snap interface {
	...
	StartServices(ctx context.Context, services []string, extraSnapArgs ...string) error   // snap[ctl] start $service
	StopServices(ctx context.Context, services []string, extraSnapArgs ...string) error    // snap[ctl] stop $service
	RestartServices(ctx context.Context, services []string, extraSnapArgs ...string) error // snap[ctl] restart $service
